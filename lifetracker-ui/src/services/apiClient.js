...
// // puts all axios calls in one generalized file
...
class ApiClient {
  ...
  async fetchUserFromToken(creds) { // take in token or creds?
...
export default new ApiClient(import.meta.env.VITE_REMOTE_HOST_URL || "http://localhost:3001") // here